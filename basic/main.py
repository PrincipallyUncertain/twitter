...
def get_args():
    ...
    parser.add_argument("--config-file",   default="config/config.json", help="Twitter account config file name")
    parser.add_argument("--data-path",     default="data",                  help="path to data file")
    parser.add_argument("--data-file",     default="twitter_dump.json",       help="data file name")
